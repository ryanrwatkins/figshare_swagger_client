...
class UploadInfo(object):
    ...
    def __init__(self, token=None, md5=None, size=None, name=None, status=None, parts=None):
        """
        UploadInfo - a model defined in Swagger
        """
    ...
    def status(self, status):
        ...
        :type: str
        """
        allowed_values = ["PENDING", "COMPLETED", "ABORTED"]
