...
class ArticleUpdate(object):
    ...
    def __init__(self, title=None, description='', is_metadata_record=None, metadata_reason=None, tags=None, keywords=None, references=None, categories=None, categories_by_source_id=None, authors=None, custom_fields=None, custom_fields_list=None, defined_type=None, funding='', funding_list=None, license=0, doi='', handle='', resource_doi='', resource_title='', timeline=None, group_id=None):
        """
        ArticleUpdate - a model defined in Swagger
        """
